...
namespace ImGui
{
    ...
    IMGUI_API void          RenderSquare(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float scale = 1.0f);
    ...
    IMGUI_API bool          SquareButtonEx(const char* str_id, ImVec2 size_arg, ImGuiButtonFlags flags);
