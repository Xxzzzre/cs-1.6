...
namespace ImGui
{
    ...
    IMGUI_API bool          ArrowButton(const char* str_id, ImGuiDir dir, float width);                  // square button with an arrow shape
    IMGUI_API bool          ArrowButtonDouble(const char* str_id, ImGuiDir dir, float width);            // square button with an double arrow shape
    IMGUI_API bool          SquareButton(const char* str_id, float width);                  // square button with an square shape
	...
	IMGUI_API bool          Combo(const char* label, float* current_item, const char* const items[], int items_count, int popup_max_height_in_items = -1);
	IMGUI_API bool          Combo(const char* label, int* current_item, const char* items_separated_by_zeros, int popup_max_height_in_items = -1);      // Separate items with \0 within a string, end item-list with \0\0. e.g. "One\0Two\0Three\0"
    IMGUI_API bool          Combo(const char* label, int* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int popup_max_height_in_items = -1);
	IMGUI_API bool          Combo(const char* label, float* current_item, bool(*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int popup_max_height_in_items = -1);
    ...
    IMGUI_API bool          DragInt7(const char* label, int v[7], float v_speed = 1.0f, int v_min = 0, int v_max = 0, const char* format = "%d");
    ...
    IMGUI_API bool          InputInt7(const char* label, int v[7], ImGuiInputTextFlags extra_flags = 0);
	...
	IMGUI_API bool          MenuItem(const char* label, const char* shortcut, float* p_selected, bool enabled = true);              // return true when activated + toggle (*p_selected) if p_selected != NULL
